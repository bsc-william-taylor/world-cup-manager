...
import application.drawables.HelpObject;
...
import application.scenes.SplashScene.HeaderButtons;
import android.view.MotionEvent;
import application.activity.MainActivity;
import application.events.ExitEvent;
import application.events.StateEvent;
import application.events.MuteEvent;
